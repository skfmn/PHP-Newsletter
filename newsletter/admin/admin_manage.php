  ...
  <input type="hidden" name="chypwd" value="yes" />
	<div class="row uniform">
      ...
      <div class="12u 12u$(small)" style="padding-bottom:10px;">
        <?php if (strtolower($cookies) == "admin") { ?>
        Admin<input type="hidden" name="cname" value="<?php echo $cookies; ?>" />
        <?php } else { ?>
        <input type="text" name="cname" value="<?php echo $cookies; ?>" required />
        <?php } ?>
      </div>
      <div class="12u 12u$(small)" style="padding-bottom:10px;">
        <label for="cypwd">Password</label>
        <div class="input-wrapper">
          <input type="password" id="cypwd" name="cypwd" required ><br />
...
?>
      ...
      <div class="12u 12u$(small)" style="padding:10px 0px;">
        ...
        <div class="input-wrapper">
          <input type="password" id="capwd" name="capwd" required><br />
  ...
  <input type="hidden" name="newadmin" value="yes" />
	<div class="row uniform">
      ...
      <div class="12u 12u$(small)" style="padding-bottom:10px;">
        ...
        <div class="input-wrapper">
          <input type="password" id="adpwd" name="adpwd" required><br />
