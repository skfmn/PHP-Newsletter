...
if (isset($_SESSION["msg"])) {
  ...
  if (isset($_POST["save"])) {
    ...
    if ($_POST["save"] == "Save as Template") {
    ...
    <div id="main" class="container">
      <div class="row">
        <div class="-3u 6u 12u(medium)">
          <span><a class="picimg fancybox.ajax" href="imageurls.php">Get Image URLs</a></span>
        </div>
      </div>
      
      <header><h2 style="text-align:center;">Create a Template</h2></header>
      <form method="post">
