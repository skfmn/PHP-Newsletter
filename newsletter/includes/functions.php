<?php
  ...
  $cookieID = "";
  if (isset($_SESSION["nwsadminID"])) { $cookieID = $_SESSION["nwsadminID"]; }
  ...
  if ($result->num_rows > 0) {
    ...
    if ($smtpDebug == "yes") {$smtpDebug = 2;} else {$smtpDebug = 0;}
    $smtpuse = $row["smtpuse"];
    $rewrite = $row["rewrite"];
  ...
  function send_mail($tMail, $tSubject, $tMsg, $tFlag, $sAttach, $tUploadfile, $tSendas) {
    ...
    if ($sAttach !== "") {
      ...
      if (SMTPUSE == "yes") {
        ...
        if ($tSendas == "txt") {$mail->IsHTML(false);} else {$mail->IsHTML(true);}
      ...
      <div id="displaymsg" style="background-color:#fff;text-align:left;width:300px;">
        <div class="left_menu_block">
          ...
          <div class="left_menu_center" align="center" style="background-color:#fff; padding-left:0px;">
            <span style="color:#444;"><?php echo $sText; ?></span>
          </div>
